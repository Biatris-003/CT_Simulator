...
class LSRMetricDialog(QDialog):
    def __init__(
        ...
        # Initialise with data if available
    ...
    def _recompute_and_render(self):
        ...
        recon_results = ComparisonReconstruction.reconstruct_lsr_from_sinograms(
            full_sino,
            sparse_sino,
            full_angles,
            sparse_angles,
    ...
    def _render_all(self):
        """Update all canvases with current reconstruction data."""
        # --- Full reconstruction ---
        self.ax_full.clear()
        ...
        if self.error_map is not None:
            ...
            self.ax_nmse.text(
                0.5, -0.15, info_text, color="#FF4800", fontsize=10,
